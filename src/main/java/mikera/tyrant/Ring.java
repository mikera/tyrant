...
public class Ring  {
    ...
    public static void initRings() {
        ...
        t.add("WieldedModifiers",Modifier.bonus("MoveSpeed",Rand.d(40)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of strength", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("ST",Rand.d(4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of skill", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("SK",Rand.d(4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of agility", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("AG",Rand.d(2,4)));
        t.set("LevelMin",10);
        addRing(t);
        
        t = Lib.extend("ring of toughness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("TG",Rand.d(2,4)));
        t.set("LevelMin",15);
        addRing(t);
        
        t = Lib.extend("ring of intelligence", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("IN",Rand.d(4)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of willpower", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("WP",Rand.d(2,4)));
        t.set("LevelMin",15);
        addRing(t);
        
        t = Lib.extend("ring of charisma", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",Rand.d(2,4)));
        t.set("LevelMin",1);
        addRing(t);
        
        t = Lib.extend("ring of craft", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CR",Rand.d(2,4)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of protection", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("ARM",Rand.d(3,4)));
        t.set("LevelMin",3);
        addRing(t);
        
        t = Lib.extend("ring of reading", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.LITERACY,Rand.d(3)));
        t.set("LevelMin",8);
        addRing(t);
        
        t = Lib.extend("ring of the great trader", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.TRADING,Rand.d(2,3)));
        t.set("LevelMin",10);
        addRing(t);
 
        t = Lib.extend("ring of thieves", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.DODGE,Rand.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.STEALTH,Rand.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.PICKLOCK,Rand.r(2)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.PICKPOCKET,Rand.r(2)));
        t.set("LevelMin",15);
        addRing(t);
		
        t = Lib.extend("ring of the warrior", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.ATTACK,Rand.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.DEFENCE,Rand.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.ARCHERY,Rand.r(3)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.THROWING,Rand.r(3)));
        t.set("LevelMin",25);
        addRing(t);
        ...
        t.add("WieldedModifiers",Modifier.bonus("RES:fire",Rand.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of ice resistance", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:ice",Rand.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of poison resistance", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:poison",Rand.d(2,6)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of antivenom", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("RES:poison",Rand.d(2,8)));
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of ferocity", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("AttackSpeed",Rand.d(40)));
        t.add("WieldedModifiers",Modifier.bonus(Skill.ATTACK,1));
        t.set("LevelMin",13);
        addRing(t);
        
        t = Lib.extend("ring of survival", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.SURVIVAL,Rand.d(3)));
        t.set("LevelMin",4);
        addRing(t);
        
        t = Lib.extend("ring of throwing", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.THROWING,Rand.d(3)));
        t.set("LevelMin",7);
        addRing(t);
        
        t = Lib.extend("ring of stealth", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(Skill.STEALTH,Rand.d(2)));
        t.set("LevelMin",22);
        addRing(t);
        
        t = Lib.extend("wedding ring", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",Rand.r(3)));
        t.set("LevelMin",9);
        addRing(t);
        
        t = Lib.extend("ring of ugliness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus("CH",-Rand.d(2,6)));
        t.set("IsCursed",1);
        t.set("LevelMin",2);
        addRing(t);
        ...
        t.add("WieldedModifiers",Modifier.bonus("MoveSpeed",-Rand.d(2,20)));
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_AG,-Rand.d(4)));
        t.set("IsCursed",1);
        t.set("LevelMin",5);
        addRing(t);
        
        t = Lib.extend("ring of weakness", "plain ring");
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_ST,-Rand.d(4)));
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_TG,-Rand.d(4)));
        t.set("IsCursed",1);
        t.set("LevelMin",9);
        addRing(t);
