...
public class Food {
    ...
    public static void eat(Thing user, Thing t) {
        ...
        if (t.getFlag("IsCursed")) {
            ...
            if(!hungerAlreadySet) {
                hunger = Maths.max(-h.getStat(RPG.ST_HUNGERTHRESHOLD), hunger - nutritionValue);
    ...
    private static void initHerbs() {
        ...
        t.set("LevelMin",7);
        t.addHandler("OnTouch",Scripts.damage("poison",Rand.d(2,4),"painfully stung by the herb!",100));
        Lib.add(t);
        ...
        t.set("LevelMin",9);
        t.addHandler("OnTouch",Scripts.damage("poison",Rand.d(4,4),"painfully stung by the herb!",100));
        Lib.add(t);
    }
