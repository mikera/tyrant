...
public class Amulet {
	...
	public static void initAmulets() {
		...
		t.set("LevelMin",18);
        t.add("WieldedModifiers",Modifier.bonus(Skill.ATTACK,Rand.d(3)));
        t.add("WieldedModifiers",Modifier.bonus(RPG.ST_ATTACKSPEED,Rand.d(2,20)));
		addNecklace(t);
		...
		t.set("LevelMin",9);
        t.add("WieldedModifiers",Modifier.bonus("ARM",Rand.d(6)));
		addNecklace(t);	
		...
		t.set("LevelMin",12);
        t.add("WieldedModifiers",Modifier.bonus(Skill.CASTING,Rand.d(3)));
        t.add("WieldedModifiers",Modifier.bonus("IN",Rand.d(2,3)));
		addNecklace(t);	
		
		t=Lib.extend("amulet of courage","base amulet");
		t.set("LevelMin",2);
        t.add("WieldedModifiers",Modifier.bonus(Skill.BRAVERY,Rand.d(3)));
		addNecklace(t);	
