...
public class Monster {
    ...
    public static class ItemDamageHit extends Script {
    	...
    	public boolean handle(Thing t, Event e) {
    		...
    		if (type.equals("item")) {
    			...
    			if (ts.length>0) target=ts[Rand.r(ts.length)];
    ...
    public static class SpecialHit extends Script {
        ...
        public boolean stealSomething(Thing target, Thing actor, String whatType) {
            ...
            Thing whatToSteal = things[Rand.r(things.length)];
            if (whatToSteal.y > 0) {
    ...
    static void initVortices() {
		/*
		 * Vortices are magical contructs of writhing energy
		 * aminated by a malevolent spirit, they will fly
		 * swiftly towards a foe and explode on contact
		 */
		Thing t;
