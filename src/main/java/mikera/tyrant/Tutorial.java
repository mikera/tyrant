...
public class Tutorial {
            ...
            switch (t.getStat("ChatCount")) {
                case 1:
                    ...
                    Game.message("He talks enthusiastically about his latest victory against a marauding " +
                            Lib.createType("IsMonster",Rand.d(16)).getName(Game.hero()) +
                            ".");
                    break;
            ...
            switch (t.getStat("ChatCount")) {
                ...
                case 4:
                    Game.message("You talk about how best to defeat " +
                            Lib.createType("IsMonster",Rand.d(16)).getAName() +
                            ".");
	...
	public static Map buildTutorialMap() {
		...
		for (int y=20; y<=23; y++) {
			for (int x=1; x<=5; x++) {
				if (Rand.d(2)==1) m.addThing(Lib.createType("IsHerb",Rand.d(6)),x,y);
			}
		}
		m.addThing(
