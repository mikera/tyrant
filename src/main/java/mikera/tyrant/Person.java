...
public class Person {
    ...
    public boolean handle(Thing t, Event e) {
      ...
      if (h.getStat(sk) > 0) {
        if (get("Practitioner") != null) {
          Game.message("\"Good day to you, fellow " + get("Practitioner") + ".\"");
        } else {
    ...
    public boolean handle(Thing t, Event e) {
      ...
      if (gift != null && damagedFlag) {
        ...
        if (value > 0) {
          ...
          char k = Game.getOption("ynq");
          if (k == 'y') {
            Game.message("You gave " + gift.getName(Game.hero()) + " and "
  ...
  private static class IdScript extends Script {
    ...
    public boolean handle(Thing t, Event e) {
      ...
      if (k == 'y') {
        ...
        // Identify the item
        Item.identify(gift);
        Game.message(t.getTheName() + " identifies it as " + gift.getAName() + ".");
      } else {
        // you don't want to pay?
        giver.message("Don't waste my time then!");
      }
  ...
  public static void initWoodFolk() {
    ...
    t.set("OnGift", SwapScript.create("IsCoin", (Rand.d(2) == 1) ? "IsScroll" : "IsIdentifyScroll", 6));
    Lib.add(t);
