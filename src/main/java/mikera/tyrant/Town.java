...
public class Town {
	...
	public static Map createTown(int w, int h) {
		...
		int[][] layout = towns[Rand.r(towns.length)];
	...
	private static void buildTown(Map m, int[][] areas) {
		...
		//buildArea(32,0,(Rand.d(3)==1)?12:RPG.pick(INNER));
		//buildArea(32,16,6);
		//buildArea(32,32,(Rand.d(3)==1)?12:RPG.pick(INNER));
		//buildArea(48,0,3);
		//buildArea(48,16,4);
	...
	private static void buildArea(Map m, int x, int y, int t) {
		...
		switch (t) {
			...
			case 3 : {
				int hw = Rand.r(3) + 3;
				int hh = Rand.r(3) + 3;
				int hx = x + 1 + Rand.r(14 - hw);
				int hy = y + 1 + Rand.r(14 - hh);
				int dx = Rand.r(2) * 2 - 1;
				int dy = Rand.r(2) * 2 - 1;
				if (Rand.d(2) == 1)
					dx = 0;
			...
			// block
			case 4 : {
				addRoom(m, x + 8 - Rand.d(2, 3), y + 8 - Rand.d(2, 3), x + 8,
						y + 8, 0, -1);
				addRoom(m, x + 8 - Rand.d(2, 3), y + 8, x + 8, y + 8
						+ Rand.d(2, 3), 0, 1);
				addRoom(m, x + 8, y + 8 - Rand.d(2, 3), x + 8 + Rand.d(2, 3),
						y + 8, 0, -1);
				addRoom(m, x + 8, y + 8, x + 8 + Rand.d(2, 3), y + 8
						+ Rand.d(2, 3), 0, 1);
				break;
			}
			...
			case 6 : {
				addShop(m, x, y, x + Rand.d(3, 2), y + Rand.d(3, 2), 1, 0, 4);
				addShop(m, x + 15 - Rand.d(3, 2), y, x + 15, y + Rand.d(3, 2), 0,
						1, 0);
				addShop(m, x, y + 15 - Rand.d(3, 2), x + Rand.d(3, 2), y + 15, 0,
						-1, 2);
				addShop(m, x + 15 - Rand.d(3, 2), y + 15 - Rand.d(3, 2), x + 15,
						y + 15, -1, 0, 3);
				break;
			}
			...
			case 11 : {
				...
				if ((t & 1) == 1) {
					// add the bridge
					m.replaceTiles(x, y + 7, x + 15, y + 7 + Rand.r(3),
			...
			case 13 : {
				...
				p1 = 7 - Rand.d(3);
				p2 = 7 + Rand.d(3);
				addFeature(m, x, y + Rand.r(2), x + p1, y + 5 + Rand.r(3), 0, 1,
						0);
				addFeature(m, x + p1, y + Rand.r(2), x + p2, y + 5 + Rand.r(3),
						0, 1, 0);
				addFeature(m, x + p2, y + Rand.r(2), x + 14, y + 5 + Rand.r(3),
						0, 1, 0);

				p1 = 8 - Rand.d(4);
				p2 = 8 + Rand.d(4);
				addFeature(m, x, y + 9 + Rand.r(3), x + p1, y + 14 - Rand.r(2),
						0, -1, 0);
				addFeature(m, x + p1, y + 9 + Rand.r(3), x + p2, y + 14
						- Rand.r(2), 0, -1, 0);
				addFeature(m, x + p2, y + 9 + Rand.r(3), x + 14, y + 14
						- Rand.r(2), 0, -1, 0);
            ...
            case 14 : {
				...
				for (int i = 0; i < 20; i++) {
					int px = x + 1 + Rand.r(14);
					int py = y + 1 + Rand.r(14);
	...
	public static void addShop(Map m, int x1, int y1, int x2, int y2, int dx,
		...
		switch (t) {
			...
			case 2 : {
				...
				for (int x = x1 + 1; x < x2; x++)
					for (int y = y1 + 1; y < y2; y++) {
						m.addThing(stockingPoint(guard,"IsWeapon", Rand.d(2,6)), x, y);
					}
			...
			case 9 : {
				...
				for (int x = x1 + 1; x < x2; x++) {
					for (int y = y1 + 1; y < y2; y++) {
						m.addThing(stockingPoint(sk,"IsRunestone", Rand.d(12)), x, y);
					}
				}
				break;
			}
	...
	public static void addBuilding(Map m) {
		int w = Rand.d(2, 4) + 3;
		int h = Rand.d(2, 4) + 3;
		int x1 = Rand.r(m.width - w);
		int y1 = Rand.r(m.height - h);
		int x2 = x1 + w;
		int y2 = y1 + h;
		int dx = Rand.r(3) - 1;
		int dy = Rand.r(3) - 1;
	...
	public static void addStandardRoom(Map m, int x1, int y1, int x2, int y2, int doorx,
		...
		switch (Rand.d(15)) {
			...
			case 8 :
			case 9 :
				door.set("IsLocked", (Rand.d(3) == 1) ? 1 : 0);
			...
			case 10 :
				...
				if (Rand.d(4)==1) m.addThing(Lib.create("[IsAnimal]"), x1, y1, x2, y2);
				break;
			case 11 : {
				if (Rand.d(4)==1) {
		...
		switch (Rand.d(12)) {
			...
			case 2 :
				if (w > 3 && h >= 3) {
					...
					m.addThing(Lib.create("stool"), location.x + 1 - 2 * Rand.r(2), location.y);
					m.addThing(Lib.create("stool"), location.x, location.y + 1 - 2 * Rand.r(2));
			...
			case 3 :
				if (w > 3 && h >= 3) {
					...
					m.addThing(Lib.create("stool"), location.x + 1 - 2 * Rand.r(2), location.y + 1 - 2 * Rand.r(2));
			...
			default:
				m.addThing(Lib.createItem(Rand.d(12)),x1,y1,x2,y2).set("IsOwned",1);
				break;
		}
	}
