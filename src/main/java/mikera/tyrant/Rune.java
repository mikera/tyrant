...
public class Rune {
	...
	private static void initRuneStones() {
		for (int i=0; i<runes.length; i++) {
			...
			t.set("LevelMin",i+6+i/3+Rand.r(i/2)); // max=50!
	...
	private static class RuneScribeScript extends Script {
		...
		public boolean handle(Thing t, Event e) {
    		...
    		String[] rs=new String[Maths.min(runes.length,skill)];
	...
	private static void initArmourRunes() {
    	...
    	t.set("LevelMin",11);
    	t.set("RuneCount",3);
       	t.add("CarriedModifiers",Modifier.addModifier("WieldedModifiers",Modifier.linear("TG",100,Rand.d(3))));
        addRune(t);
	...
	private static void initShieldRunes() {
    	...
    	t.set("LevelMin",5);
    	t.set("RuneCount",3);
       	t.add("CarriedModifiers",Modifier.addModifier("WieldedModifiers",Modifier.linear("WP",100,Rand.d(3))));
        addRune(t);
	...
	private static void initWeaponRunes() {
    	...
    	t.add("CarriedModifiers",Modifier.bonus("ExtraASTBonus",Rand.d(2,4)));
        addRune(t);
        
     	t=Lib.extend("defence rune","base weapon rune");
    	t.set("LevelMin",4);
    	t.set("RuneCount",2);
    	t.add("CarriedModifiers",Modifier.bonus("DSKBonus",Rand.d(2,4)));
        addRune(t);
        
     	t=Lib.extend("strength rune","base weapon rune");
    	t.set("LevelMin",14);
    	t.set("RuneCount",4);
       	t.add("CarriedModifiers",Modifier.addModifier("WieldedModifiers",Modifier.linear("ST",100,Rand.d(3))));
        addRune(t);
    	...
    	t.add("CarriedModifiers",Modifier.bonus("ExtraASTBonus",Rand.d(2,5)));
        addRune(t);
    	...
    	t.add("CarriedModifiers",Modifier.constant("ExtraDamageType","fire"));
    	t.add("CarriedModifiers",Modifier.bonus("ExtraASTBonus",Rand.d(3,6)));
        addRune(t);
