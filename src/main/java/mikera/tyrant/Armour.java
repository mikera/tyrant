...
public class Armour {
    ...
    private static void initGloves() {
    	...
    	t.set("ItemWeight",900);
    	t.multiplyStat("Frequency",0.2);
        t.add("WieldedModifiers",Modifier.bonus("ST",Rand.d(3)));
    	Lib.add(t);
    ...
    private static void initFootwear() {
        ...
        t.set("UName","worn boots");
        t.set("LevelMin", 6);
        t.add("WieldedModifiers",Modifier.linear("AG",100,Rand.d(2,6)));
        addFootwear(t);
    ...
    public static void addWithVariants(Thing a) {
        ...
        for (int i=0; i<amat.length; i++) {
            ...
            t.set("LevelMin",Maths.max(1,levels[i]+t.getStat("LevelMin")));
