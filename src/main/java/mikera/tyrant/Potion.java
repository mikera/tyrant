...
public class Potion  {
    ...
    public static void addPotion(Thing t) {
        int style=Rand.r(potionstyles.length);
        int colour=Rand.r(potioncolours.length);
    ...
    public static void initRandomPotions() {
        ...
        t.set("LevelMin",8);
        // create bonus effect
        {	Thing effect=Effect.temporary(Modifier.bonus("ST",Rand.d(2,6)),2000);
        ...
        t.set("LevelMin",6);
        // create bonus effect
        {	Thing effect=Effect.temporary(Modifier.bonus("IN",Rand.d(3,6)),2000);
        ...
        // create bonus effect
        {	
        	Thing effect=Effect.temporary(Modifier.bonus("CH",Rand.d(2,8)),2000);
        ...
        // create bonus effect
        {	
        	Thing effect=Effect.temporary(Modifier.bonus("AttackSpeed",Rand.d(2,30)),2000);
        ...
        t.set("OnDrunk",new Script() {
            ...
            public boolean handle(Thing t, Event e) {
        		...
        		h=Maths.min(h,ht*(t.getFlag("IsCursed")?3:2));
        		
        		user.message("You feel hunger gnawing at your stomach");
        		return false;
        	}
        });
        t.set("IsCursed",Rand.r(2));
        t.set("LevelMin",8);
        Lib.add(t);
            ...
            public boolean handle(Thing t, Event e) {
        		...
        		if (skills.size()>0) {
         		...
         		if ((s!=null)&&(user.getBaseStat(s)>0)) {
         			...
         			} else if (t.getFlag("IsBlessed")||Rand.d(2)==1) {
         				if (Rand.d(6)>1) user.incStat("SkillPoints",1);
         			}
         		} else {
