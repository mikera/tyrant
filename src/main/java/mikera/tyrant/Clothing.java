...
public class Clothing {
    ...
    private static void initBelts() {
        ...
        addMagicVariants("IsBelt",10,Modifier.bonus(RPG.ST_ST,Rand.d(2,3)),""," of strength",8,false);
        addMagicVariants("IsBelt",10,Modifier.bonus(RPG.ST_ST,-Rand.d(2,3)),""," of strength ",8,true);
    }
                ...
                for (int j = 0; j < clothingColors.length; j++) {
                    if ((fabric.colorMask & clothingColors[j].mask) > 0) {
                        ...
                        if (resist == 0) {
                            ...
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:fire",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == ICE) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:ice",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        }
                        ...
                        if (resist == 0) {
                            ...
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:water",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == SHOCK) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:shock",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == PIERCING) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:piercing",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == POISON) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:poison",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == CHILL) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:chill",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == ACID) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:acid",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
                        } else if (resist == IMPACT) {
                            thing.add("WieldedModifiers",Modifier.bonus("ARM:impact",Rand.d(2,3)));
                            thing.set("IsMagicItem",1);
