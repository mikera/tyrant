    ...
    {	"?toor tog",
        ...
        public static void initSpellScrolls() {
            ...
            for (String spellName: sa) {
                ...
                t.set("Frequency",(Rand.d(2,100)*spell.getStat("Frequency"))/100);
                ...
                t.set("LevelMin",Maths.max(1,spell.getLevel()-10));
        ...
        public static void initSpecialScrolls() {
            ...
            t.set("OnRead",new Script() {
				...
				public boolean handle(Thing t, Event e) {
            		...
            		Thing it=its[Rand.r(its.length)];
            ...
            t.set("OnRead",new Script() {
				...
				public boolean handle(Thing t, Event e) {
            		...
            		for (int i=0; i<its.length; i++) {
            			if ((!t.getFlag("IsCursed"))&&(Rand.d(2)==1)) continue;
            ...
            t.set("OnRead",new Script() {
				...
				public boolean handle(Thing t, Event e) {
            		...
            		for (int i=Rand.d(6); i>0; i--) {
            			Thing it=its[Rand.r(its.length)];
            			if ((Rand.d(4)==1)&&!it.getFlag("IsArtifact")&&!it.getFlag("IsCursed")) {
